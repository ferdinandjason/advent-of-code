...
pub fn solve(input: &Input) -> (usize, usize) {
    ...
    for (_, coords) in &input.antennas {
        for i in 0..coords.len() {
            for j in 0..i {
                ...
                if (x1 - dx) >= 0
                    && (x1 - dx) < input.maps.len() as isize
                    && (y1 - dy) >= 0
                    && (y1 - dy) < input.maps[0].len() as isize
                {
                ...
                if (x2 + dx) >= 0
                    && (x2 + dx) < input.maps.len() as isize
                    && (y2 + dy) >= 0
                    && (y2 + dy) < input.maps[0].len() as isize
                {
                ...
                while x1 >= 0
                    && x1 < input.maps.len() as isize
                    && y1 >= 0
                    && y1 < input.maps[0].len() as isize
                {
                ...
                while x2 >= 0
                    && x2 < input.maps.len() as isize
                    && y2 >= 0
                    && y2 < input.maps[0].len() as isize
                {
